	...
	GIFEncoder = function()
	{
      ...
      ByteArray.prototype.writeBytes = function(array, offset, length){
		...
		*/
		...
		var addFrame = exports.addFrame = function addFrame(im/*BitmapData*/, colors, is_imageData)/*Boolean*/
		{	
			...
			analyzePixels(colors); // build color table & map pixels
		...
		* Analyzes image colors and creates color map,
                * unless the color map is provided as an argument.
		*/
		
		var analyzePixels = function analyzePixels(colors)/*void*/
		{
